...
Wem das Weitersagen zu bunt wird, der nimmt eine **eigene Domain** (etwa 10 € im Jahr) und einen
*benannten* Tunnel. Der arbeitet andersherum: Nicht der Tunnel leiht sich eine Adresse, sondern die
...
ins Leere. Schritt für Schritt steht das im
[Einrichtungs-Handbuch 6.5](docs/EINRICHTUNG.md#65-die-feste-adresse-eine-eigene-domain).
...
Der andere Weg zu einer festen Adresse ist **[Tailscale](https://tailscale.com/)** – kostenlos für den
privaten Gebrauch, echtes HTTPS auf einer `*.ts.net`-Adresse, alles privat im eigenen Netz. Verlangt
allerdings, dass **jeder Mitspieler Tailscale installiert**; der Tunnel braucht bei ihnen nur einen
Browser.
